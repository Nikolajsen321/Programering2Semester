...
public class Studerende1 implements Comparable<Studerende1> {
    private int studieNr;
    private String navn;
    private List<Integer> karakter = new ArrayList<>();

    public Studerende1(int studieNr, String navn, List<Integer> karakter) {
    ...
    @Override
    public int compareTo(Studerende1 o) {

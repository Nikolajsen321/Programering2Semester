	...
	public PN opretPNOrdination(LocalDate startDen, LocalDate slutDen,
		...
		if(checkStartFoerSlut(startDen,slutDen)){
			if(antal >= 0) {
				...
				String string ="Antal skal være større end eller lig med 0";
...
//		long month = ChronoUnit.MONTHS.between(startDen,slutDen);
		...
		if(checkStartFoerSlut(startDen,slutDen)){
			LocalTime morgenTid = LocalTime.of(8,0);
			LocalTime middagsTid = LocalTime.of(12,0);
			LocalTime aften = LocalTime.of(18,0);
			LocalTime nat = LocalTime.of(2,0);

			DagligFast dagligFastOrdination = new DagligFast(startDen,slutDen,laegemiddel);
			patient.addOrdanition(dagligFastOrdination);
			dagligFastOrdination.opretDosis(morgenTid,morgenAntal);
			dagligFastOrdination.opretDosis(middagsTid,middagAntal);
			dagligFastOrdination.opretDosis(aften,aftenAntal);
			dagligFastOrdination.opretDosis(nat,natAntal);
	...
	public DagligSkaev opretDagligSkaevOrdination(LocalDate startDen,
		...
		if(checkStartFoerSlut(startDen,slutDen)){
			if(antalEnheder.length > 0) {
				...
				String string ="Antal skal være større end 0";
	...
	public double anbefaletDosisPrDoegn(Patient patient, Laegemiddel laegemiddel) {
		...
		if(patient.getVaegt() > 3) {
			...
			String string ="Skal være ældre end 3";
			throw  new RuntimeException(string);
		}
	...
	public void createSomeObjects() {
		...
		this.opretPNOrdination(LocalDate.of(2023, 1, 1), LocalDate.of(2023, 1, 12),
